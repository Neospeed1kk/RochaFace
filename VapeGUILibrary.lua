-- GUI Library (salvar como: VapeGUILibrary.lua)
local VapeGUI = {}
...
local gui, scaledgui, clickgui, moduleholder, scale, notifications
local expanded
...
function mainapi:CreateCategory(categorysettings)
    ...
    function categoryapi:CreateModule(modulesettings)
        ...
        -- Container dos elementos do módulo
...
function VapeGUI:Initialize()
    if mainapi.gui then return end
    ...
    -- Ajustar tamanho da GUI escalável
...
-- Função para adicionar novo módulo dinamicamente
...
-- Função para obter API principal
function VapeGUI:GetAPI()
    return mainapi
end

-- Função para listar módulos existentes
