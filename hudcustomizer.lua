...
local function createSection(name, targetName, layoutOrder, config)
    ...
    sliderFrame.Position = UDim2.new(0, 10, 0, isSpecial and 45 or 75)
    ...
    hexInput.Size = UDim2.new(0, 80, 0, 25)
    hexInput.Position = UDim2.new(0, 10, 0, isSpecial and 70 or 100)
    hexInput.BackgroundColor3 = Color3.fromRGB(12, 12, 15)
    ...
    colorPreview.Position = UDim2.new(0, 95, 0, isSpecial and 70 or 100)
    ...
    rainbowBtn.Position = UDim2.new(1, -110, 0, isSpecial and 70 or 100)
    rainbowBtn.BackgroundColor3 = Color3.fromRGB(12, 12, 15)
    ...
    if hasVisibility then
        visBtn = Instance.new("TextButton")
        visBtn.Size = UDim2.new(0, 100, 0, 25)
        visBtn.Position = UDim2.new(0, 10, 0, isSpecial and 105 or 135)
        visBtn.BackgroundColor3 = Color3.fromRGB(12, 12, 15)
    ...
    if hasTransparency then
        transInput = Instance.new("TextBox")
        transInput.Size = UDim2.new(0, 50, 0, 25)
        transInput.Position = UDim2.new(hasVisibility and 0.35 or 0, 80, 0, isSpecial and 105 or 135)
        transInput.BackgroundColor3 = Color3.fromRGB(12, 12, 15)
        transInput.Text = "0"
    ...
    UserInputService.InputChanged:Connect(function(io)
        if draggingSlider and io.UserInputType == Enum.UserInputType.MouseMovement then
            ...
            hexInput.Text = colorToHex(Color3.fromHSV(pos, 1, 1))
        end
    end)
    ...
    local function triggerUpdate()
        ...
        local function applyToObj(obj)
            ...
            if obj:IsA("TextLabel") then
                ...
                if not rainbowEnabled then obj.TextColor3 = col end
...
local function loadCurrentData()
    ...
    if nameplate then
        for targetName, s in pairs(sections) do
            ...
            local h, _, _ = Color3.toHSV(hexToColor3(s.hex.Text))
            s.knob.Position = UDim2.new(h, 0, 0.5, 0)
        end
    end
